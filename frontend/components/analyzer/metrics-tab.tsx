    ...
    <div className="space-y-6">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <MetricCard label="Average Gas Used" value={num(gas.averageGasUsed)} sub="Typical gas per tx" info="Average gas units per transaction. ~46k is normal for ERC-20 transfers. Higher values (150k+) indicate complex DEX/router interactions. As a mean, it can be skewed by outlier transactions." />
